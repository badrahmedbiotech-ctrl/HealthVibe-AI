...
""",
    ...
    "ar": {
        ...
        "Open Lipid Profile": "فتح الدهون",
        "Open CT Scan AI": "فتح الأشعة المقطعية",
...
""",
        ...
        # --- Dashboard.py ---
        "HealthVibe AI Dashboard": "لوحة تحكم HealthVibe AI",
        ...
        "Latest Prediction:": "أحدث تشخيص:",
        "❤️ Risk Indicator": "❤️ مؤشر الخطورة",
        "Excellent": "ممتاز",
        "📊 Platform Statistics": "📊 إحصائيات المنصة",
        "Assessments": "التقييمات",
        "🩺 AI Disease Prediction Modules": "🩺 وحدات التنبؤ بالأمراض بالذكاء الاصطناعي",
        "Blood Glucose Risk Prediction": "التنبؤ بمخاطر سكر الدم",
        "Blood Pressure Analysis": "تحليل ضغط الدم",
        "Cholesterol Risk Assessment": "تقييم مخاطر الكوليسترول",
        "BMI & Weight Risk": "مؤشر كتلة الجسم ومخاطر الوزن",
        "Pulmonary": "تليّف الرئة",
        "Blood Clot Prediction": "التنبؤ بالجلطات الدموية",
        "Coming Soon": "قريبًا",
        "More AI models are under development.": "المزيد من نماذج الذكاء الاصطناعي قيد التطوير.",
        "Open Lipid Profile": "فتح الدهون",
        "Open CT Scan AI": "فتح الأشعة المقطعية",
        "Open Thrombosis": "فتح الجلطات",
        "🔔 Notifications": "🔔 الإشعارات",
        "⚡️ System Status": "⚡️ حالة النظام",
        "🟢 Models": "🟢 النماذج",
        "🟢 Authentication": "🟢 المصادقة",
        "📈 Recent Activity": "📈 النشاط الأخير",
        "No assessments yet.": "لا توجد تقييمات بعد.",
        "📄 Latest Assessments": "📄 أحدث التقييمات",
        "No reports yet.": "لا توجد تقارير بعد.",
        "👤 Patient Dashboard": "👤 لوحة المريض",
        "📊 Personal Statistics": "📊 الإحصائيات الشخصية",
        "Health Score": "درجة الصحة",
        "Latest Result": "أحدث نتيجة",
        "💡 Daily Health Tips": "💡 نصائح صحية يومية",
        "🥗 Eat healthy food": "🥗 تناول طعامًا صحيًا",
        "🏃 Exercise regularly": "🏃 مارس الرياضة بانتظام",
        "😴 Sleep 7-8 hours": "😴 نم 7-8 ساعات",
        "🚭 Avoid smoking": "🚭 تجنب التدخين",
        "👨‍⚕️ Doctor Dashboard": "👨‍⚕️ لوحة الطبيب",
        "👥 Patient Management": "👥 إدارة المرضى",
        "View and manage all registered patients.": "عرض وإدارة جميع المرضى المسجلين.",
        "Open Patient Manager": "فتح إدارة المرضى",
        "📈 AI Analytics": "📈 تحليلات الذكاء الاصطناعي",
        "Monitor AI performance and predictions.": "مراقبة أداء الذكاء الاصطناعي والتنبؤات.",
        "Open Analytics": "فتح التحليلات",
        "Manage doctor accounts.": "إدارة حسابات الأطباء.",
        "Online Doctors": "الأطباء المتصلون",
        "Manage Doctors": "إدارة الأطباء",
        "⚡️ Quick Access": "⚡️ الوصول السريع",
        "🤖 AI Chatbot": "🤖 روبوت الدردشة الذكي",
        "⚙️ Settings": "⚙️ الإعدادات",
        "🧠 AI Insights": "🧠 رؤى الذكاء الاصطناعي",
        "📊 Risk Distribution": "📊 توزيع المخاطر",
        "Based on your previous assessments, your overall health trend is improving.": "بناءً على تقييماتك السابقة، فإن اتجاه صحتك العام في تحسن.",
        "💡 AI Recommendation": "💡 توصية الذكاء الاصطناعي",
        "Continue regular screening.": "استمر في الفحص الدوري.",
        "Maintain healthy diet.": "حافظ على نظام غذائي صحي.",
        "Exercise at least 150 min/week.": "مارس الرياضة 150 دقيقة أسبوعيًا على الأقل.",
        "Repeat laboratory tests every 6 months.": "أعد إجراء التحاليل المعملية كل 6 أشهر.",
        "Welcome to HealthVibe AI": "مرحبًا بك في HealthVibe AI",
        "Latest assessment :": "أحدث تقييم :",
        "Doctors Online": "أطباء متصلون",
        "Last Login :": "آخر تسجيل دخول :",
        "AI models updated successfully": "تم تحديث نماذج الذكاء الاصطناعي بنجاح",
        "New medical report available": "تقرير طبي جديد متاح",
        "Annual health check recommended": "يُنصح بإجراء فحص صحي سنوي",
        "Database synchronized": "تمت مزامنة قاعدة البيانات",
        "🟢 AI Server Online": "🟢 خادم الذكاء الاصطناعي متصل",
        "🟢 Database Connected": "🟢 قاعدة البيانات متصلة",
        "🟢 Secure Connection": "🟢 اتصال آمن",
        "📊 Platform Analytics": "📊 تحليلات المنصة",
        "System Status": "حالة النظام",
        "Healthy": "سليم",
        "🧠 AI Health Insights": "🧠 رؤى صحية بالذكاء الاصطناعي",
        "🤖 AI Recommendation": "🤖 توصية الذكاء الاصطناعي",
        "Great start. Continue monitoring your health regularly.": "بداية رائعة. استمر في متابعة صحتك بانتظام.",
        "Keep following healthy habits and review your reports.": "استمر في اتباع العادات الصحية ومراجعة تقاريرك.",
        "You have many assessments. Regular physician follow-up is recommended.": "لديك العديد من التقييمات. يُنصح بالمتابعة الدورية مع الطبيب.",
        "📈 AI Prediction Distribution": "📈 توزيع تنبؤات الذكاء الاصطناعي",
        "📅 Smart Appointment Booking": "📅 حجز موعد ذكي",
        "📱 HealthVibe Mobile App": "📱 تطبيق HealthVibe للموبايل",
        "👤 Account": "👤 الحساب",
        "Version 2.0 • Secure • Intelligent • Fast": "الإصدار 2.0 • آمن • ذكي • سريع",
        "Made with ❤️ using Streamlit + AI": "صُنع بـ ❤️ باستخدام Streamlit والذكاء الاصطناعي",
        "🟢 AI System Online": "🟢 النظام يعمل الآن",
        "👋 Welcome Back,": "👋 أهلاً بعودتك،",
        "Your Intelligent Clinical Decision Support Platform": "منصتك الذكية لدعم القرار السريري",
        "📝 Create New Account": "📝 إنشاء حساب جديد",
    }
}
